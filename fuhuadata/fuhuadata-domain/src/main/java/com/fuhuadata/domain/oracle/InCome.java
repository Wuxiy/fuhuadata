...
public class InCome extends BaseEntity<String> {
    ...
    @Column(name = "FHZQDAYS")
    private String fhzqdays;
    ...
    public void setDiseffectdate(String diseffectdate) {
        this.diseffectdate = diseffectdate == null ? null : diseffectdate.trim();
    }
     ...
     * @param fhzqdays
     */
    public void setFhzqdays(String fhzqdays) {
        this.fhzqdays = fhzqdays == null ? null : fhzqdays.trim();
    }
